...
TASK: Code is difficult to test (mixed I/O, missing inverses)
  → Read @references/refactoring.md (refactoring patterns for testability)
...
TASK: Need library reference
  → Read @references/libraries.md (PBT libraries by language, includes smart contract tools)
```
